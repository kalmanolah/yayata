...
export const NINETOFIVER_RELOAD_LEAVE_TYPES = 'NINETOFIVER/LOAD_LEAVE_TYPES';
export const NINETOFIVER_RELOAD_PERFORMANCE_TYPES = 'NINETOFIVER/SET_PERFORMANCE_TYPES';
export const NINETOFIVER_RELOAD_EMPLOYMENT_CONTRACT_TYPES = 'NINETOFIVER/SET_EMPLOYMENT_CONTRACT_TYPES';
export const NINETOFIVER_RELOAD_CONTRACT_GROUPS = 'NINETOFIVER/SET_CONTRACT_GROUPS';
export const NINETOFIVER_RELOAD_COMPANIES = 'NINETOFIVER/SET_COMPANIES';
export const NINETOFIVER_RELOAD_CONTRACTS = 'NINETOFIVER/SET_CONTRACTS';
export const NINETOFIVER_RELOAD_TIMESHEETS = 'NINETOFIVER/SET_TIMESHEETS';


//Mutations
export const NINETOFIVER_SET_USER = 'NINETOFIVER/SET_USER';
export const NINETOFIVER_SET_LEAVE_TYPES = 'NINETOFIVER/LOAD_LEAVE_TYPES';
